...
{
	public class MaterialRaisedButtonCustom : Button, IMaterialControl
	{
		[Browsable(false)]
		...
		public MaterialRaisedButtonCustom()
		{
			Primary = true;
		...
		protected override void OnPaint(PaintEventArgs pevent)
		{
				...
				1f))
			{
				...
				g.FillPath(new SolidBrush(Enabled ? EnabledBGColor : DisabledBGColor), backgroundPath);
			}
            ...
            Rectangle iconRect = new Rectangle(8, 5, 13, 13);

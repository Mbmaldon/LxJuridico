...
{
    public partial class frmHistorialLlamadas : Form
    {
        UsuarioData AUsuario = UsuarioData.Instancia;
        MRUEdit edit;
        public frmHistorialLlamadas()
        {
            InitializeComponent();
            InitializeControls();
        }
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (sfdExportarLlamadas.ShowDialog() == DialogResult.OK)
                {
                    grdLlamadas.ExportToXlsx(sfdExportarLlamadas.FileName);
                    Process.Start(sfdExportarLlamadas.FileName);
                }
            }
        }
        ...
        #region FUNCIONES
        /// <summary>
        /// Carga la información que se cargara desde un principio
        /// </summary>
        public void InitializeControls()
        {
            grdLlamadas.DataSource = new Llamada().GetListHistory(int.Parse(AUsuario.sIdusuario));
            CountCalls();

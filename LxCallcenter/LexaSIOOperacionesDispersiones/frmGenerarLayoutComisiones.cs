...
{
	public partial class frmGenerarLayoutComisiones : Form
	{
		UsuarioData AUsuario = UsuarioData.Instancia;
		frmComision _Comision = Application.OpenForms["frmComision"] as frmComision;
		...
		public frmGenerarLayoutComisiones() : this(false) { }

		public frmGenerarLayoutComisiones(bool useSlideAnimation)
		{
			InitializeComponent();
			_UseSlideAnimation = useSlideAnimation;
		}
		//public frmGenerarLayoutComisiones()
		//{
		//	InitializeComponent();
		//}

		static frmGenerarLayoutComisiones _GenerarLayout;
		...
		{
			_GenerarLayout = new frmGenerarLayoutComisiones();
		...
		private void InitializeControls(bool bTipo)
		{
			...
			cmbxCuentaOrigen.DataSource		= new LogicaCC.LexaSIOOperLogica.Cuenta().GetListCuentaOrigenComisiones();
			cmbxCuentaOrigen.ValueMember	= "iIdCuenta";
			cmbxCuentaOrigen.DisplayMember	= "sCuenta";
			cmbxCuentaOrigen.SelectedIndex  = -1;

			LogicaCC.LexaSIOOperLogica.Dispersion _Dispersion = new LogicaCC.LexaSIOOperLogica.Dispersion().GetInfoForLayaut(1);

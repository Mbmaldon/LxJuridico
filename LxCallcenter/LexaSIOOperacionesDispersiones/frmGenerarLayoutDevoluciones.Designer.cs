...
{
	partial class frmGenerarLayoutDevoluciones
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.btnGenerarLayout.TabIndex = 258;
			...
			this.lblNumArchivos.TabIndex = 257;
			...
			this.pgrbProgreso.TabIndex = 255;
			...
			this.txtReferencia.TabIndex = 253;
			...
			this.materialLabel3.TabIndex = 252;
			...
			this.txtRfcOrdenante.TabIndex = 251;
			...
			this.materialLabel2.TabIndex = 250;
			...
			this.txtDescripcion.TabIndex = 249;
			...
			this.cmbxCuentaOrigen.Location = new System.Drawing.Point(54, 86);
			...
			this.cmbxCuentaOrigen.Size = new System.Drawing.Size(203, 29);
			this.cmbxCuentaOrigen.TabIndex = 259;
			this.cmbxCuentaOrigen.TabStop = false;
			this.cmbxCuentaOrigen.UseSystemPasswordChar = false;
			this.cmbxCuentaOrigen.ValueMember = "";
			// 
			// frmGenerarLayoutDevoluciones
			// 
			...
			this.Name = "frmGenerarLayoutDevoluciones";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Text = "frmGenerarLayoutDevoluciones";

...
{
    public partial class frmCitasAgendasHoy : Form
    {
        UsuarioData AUsuario = UsuarioData.Instancia;
        public frmCitasAgendasHoy()
        {
            InitializeComponent();
            InitializeControls();
        }
        ...
        {
            grdCitas.DataSource = new Cita().GetListToday(int.Parse(AUsuario.sIdusuario));
            CountCitas();
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            if (gridView1.RowCount != 0)
            {
                ...
                {
                    grdCitas.ExportToXlsx(saveFileDialog1.FileName);
